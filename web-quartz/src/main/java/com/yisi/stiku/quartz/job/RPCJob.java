...
public class RPCJob implements Job {
	...
	public void execute(JobExecutionContext context)
		...
		if (isAysn) {
			...
			try {
				...
				request = AsynRpcRequest.newInstance(className, "1.0.0",
						methodName, null, null).buildCallBackRequest(false,
		...
		/*
		 * long a = 1; Object t = RpcClientUtil.sendRequest(nettyClientRouter,
		 * className, "1.0.0", methodName, new Object[] { a }, new Class[] {
		 * long.class }); System.out.println(t);
		 */
