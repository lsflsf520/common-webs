...
//				return;
			...
			if(this.entity.qqNumber && this.entity.qqNumber.length > 20){
				this.showWarning("qqWarning");
				location.href="#qqWarning";
			    return false;
			}
...
//				location.reload();
		...
		{
			if($("#scoreSegDl").hasClass("sel-disable")){
				return;//如果学习程度不可用，则这个地方不可选
			}
