...
public class DocxTool {
	public static void createHyperlink(WordprocessingMLPackage wordMLPackage,
		   ...
		   */
		  public static void saveWordPackage(WordprocessingMLPackage wordPackage, File file)
		      throws Exception {
		   ...
		   */
		  public static WordprocessingMLPackage createWordprocessingMLPackage()
		      throws Exception {
		   ...
		   */
		  public static WordprocessingMLPackage loadWordprocessingMLPackageWithPwd(
		   ...
		   */
		  public static WordprocessingMLPackage loadWordprocessingMLPackage(String filePath)
		      throws Exception {
		   ...
		   */
		  public static void setTblBorders(TblPr tblPr, CTBorder topBorder,
		   ...
		   */
		  public static void setTableCellMargin(Tbl tbl, String top, String right,
		   ...
		   * @deprecated
		   */
		  public static void deleteTableByIndex(WordprocessingMLPackage wordMLPackage,
		   ...
		   * @deprecated
		   */
		  public static List<Object> getObjectByXpath(WordprocessingMLPackage wordMLPackage,
		   ...
		   * @Description: 添加图片到段落
		   */
		  public static void addImageToPara(WordprocessingMLPackage wordMLPackage,
		   ...
		   */
		  public static void setParagraphSpacing(P p, boolean isSpace, String before,
		   ...
		   */
		  public static void setParagraghBorders(P p, CTBorder topBorder,
		   ...
		   * @Description: 设置字体
		   */
		  public static void setFontFamily(RPr runProperties, String cnFontFamily,
		      String enFontFamily) {
		   ...
		   * @Description: 设置字符边框
		   */
		  public static void addRPrBorderStyle(RPr runProperties, String size,
		   ...
		   * @Description: 设置删除线样式
		   */
		  public static void addRPrStrikeStyle(RPr runProperties, boolean isStrike,
		      boolean isDStrike) {
		    // 删除线
		    if (isStrike) {
		   ...
		   * @Description: 添加下划线
		   */
		  public static void addRPrUnderlineStyle(RPr runProperties,
		   ...
		   */
		  public static void setDocSectionBreak(WordprocessingMLPackage wordPackage,
		      String sectValType) {
		   ...
		   * @Description: 设置页面背景色
		   */
		  public static void setDocumentBackGround(WordprocessingMLPackage wordPackage,
		   ...
		   * @Description: 设置页面边框
		   */
		  public static void setDocumentBorders(WordprocessingMLPackage wordPackage,
		   ...
		   * @Description：设置页边距
		   */
		  public static void setDocMarginSpace(WordprocessingMLPackage wordPackage,
		   ...
		   */
		  public static void setDocTextDirection(WordprocessingMLPackage wordPackage,
		   ...
		   */
		  public static void setDocVAlign(WordprocessingMLPackage wordPackage,
		   ...
		   */
		  public static int getWritableWidth(WordprocessingMLPackage wordPackage)
		      throws Exception {
