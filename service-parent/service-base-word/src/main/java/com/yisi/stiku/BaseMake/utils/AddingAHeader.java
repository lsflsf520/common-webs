...
public class AddingAHeader {
    ...
    public static void main (String[] args) throws Docx4JException {  
        ...
        Relationship relationship = createHeaderPart(wordMLPackage,factory,"Header Test");  
        createHeaderReference(relationship,wordMLPackage,factory);  
   
        wordMLPackage.getMainDocumentPart().addParagraphOfText("Hello Word!");  
   
        wordMLPackage.save(new File("D:/log/Header.docx") );  
    }  
     ...
     */  
    public static Relationship createHeaderPart(WordprocessingMLPackage wordMLPackage,ObjectFactory factory,String footText) throws InvalidFormatException {  
        HeaderPart headerPart = new HeaderPart();  
        headerPart.setPackage(wordMLPackage);  
   
        headerPart.setJaxbElement(createHeader(footText,factory));  
